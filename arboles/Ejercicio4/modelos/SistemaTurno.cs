...
using arboles.Ejercicio4.Interfaces;

namespace arboles.Ejercicio4.modelos
{
    public class SistemaTurno : IGestor
    {
        private Nodo raiz;
        ...
        {
            raiz = InsertarRec(raiz, new Cta(turno, paciente, especialidad, hora));
        }

        private Nodo InsertarRec(Nodo actual, Cta cita)
        {
